...
#ax2.set(xlim=(1e-1,10), ylim=(0, 6e21))
...
#dat = loadtxt("data/scalarB_spectrum_fixed_1e-3.dat")
#ax2.plot(dat[:,0]/1e3,dat[:,1], ls=':', label='m = 1 meV')

#dat = loadtxt("data/scalarB_spectrum_fixed_1e0.dat")
#ax2.plot(dat[:,0]/1e3,dat[:,1], ls='-.', label='m = 1 eV')
...
ax2.plot(dat[:,0]/1e3,dat[:,1], ls=':', label='B-field 1e3')
...
plt.savefig('plots/comparison_cham-log.jpg')
plt.show()
