...
ax2.set(xlim=(0,10), ylim=(0, 1e59))


dat = loadtxt("data/primakoff_spectrum_1e0-2.dat")
#dat[:,1] = dat[:,1]/np.nanmax(dat[:,1])
ax2.plot(dat[:,0]/1e3,dat[:,1], ls='-', label='Fixed m = 1eV')

dat = loadtxt("data/primakoff_spectrum_cham_1e3-2.dat")
#dat[:,1] = dat[:,1]/np.nanmax(dat[:,1])
ax2.plot(dat[:,0]/1e3,dat[:,1], ls='--', label='Bm = 1e3')

dat = loadtxt("data/primakoff_spectrum_cham_1e6-2.dat")
#dat[:,1] = dat[:,1]/np.nanmax(dat[:,1])
ax2.plot(dat[:,0]/1e3,dat[:,1], ls='--', label='Bm = 1e6')

dat = loadtxt("data/primakoff_spectrum_cham_1e7-2.dat")
#dat[:,1] = dat[:,1]/np.nanmax(dat[:,1])
...
plt.savefig('plots/primakoff_spectrum_cham_2-lin.jpg')
plt.show()
